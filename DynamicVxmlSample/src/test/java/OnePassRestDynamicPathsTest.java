...
/**
 * Created by sadurtinova on 14.09.2016.
 */
public class OnePassRestDynamicPathsTest {

    private static final OnePassRestPaths REST_PATHS = new OnePassRestPaths("192.168.29.169", "8079", "ivr_dynamic", true);
    ...
    public void testGetPersonUri (){
        Assert.assertEquals("http://192.168.29.169:8079/ivr_dynamic/rest/v4/" +
                        "person/01",
