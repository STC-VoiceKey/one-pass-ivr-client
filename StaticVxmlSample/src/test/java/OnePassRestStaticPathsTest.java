...
public class OnePassRestStaticPathsTest {
    ...
    private static final OnePassRestPaths REST_PATHS = new OnePassRestPaths("192.168.29.169", "8079", "ivr_static", false);
    ...
    public void testGetPersonUri (){
        Assert.assertEquals("http://192.168.29.169:8079/ivr_static/rest/v4/" +
                        "person/01",
